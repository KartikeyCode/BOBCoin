    ...
    <div id="How" className="mx-8 my-16 xl:my-60 md:mx-28 md:my-32 ">
      ...
      <div className="xl:-ml-12 xl:justify-around flex flex-col lg:flex-row xl:mt-28">
        <a
          ...
          className="xl:mt-0 mt-5 lg:w-80 group relative block h-64 sm:h-80 lg:h-96"
        >
          ...
          <div className="rounded-xl relative flex h-full transform items-end border-2 border-[#E8AA42] bg-white transition-transform group-hover:-translate-x-2 group-hover:-translate-y-2">
            ...
            <div className="absolute p-4 opacity-0 duration-300 transition-opacity group-hover:relative group-hover:opacity-100 sm:p-6 lg:p-8">
        ...
        >
          ...
          <div className="rounded-xl relative flex h-full transform items-end border-2 border-[#E8AA42] bg-white transition-transform group-hover:-translate-x-2 group-hover:-translate-y-2">
            ...
            <div className="absolute p-4 opacity-0 duration-300 transition-opacity group-hover:relative group-hover:opacity-100 sm:p-6 lg:p-8">
              ...
              <p className="mt-4 text-sm sm:text-base">
                Have BNB in your wallet to switch to $BOB. If you don't have any
        ...
        >
          ...
          <div className="rounded-xl relative flex h-full transform items-end border-2 border-[#E8AA42] bg-white transition-transform group-hover:-translate-x-2 group-hover:-translate-y-2">
            ...
            <div className="absolute p-4 opacity-0 duration-300 transition-opacity group-hover:relative group-hover:opacity-100 sm:p-6 lg:p-8">
              ...
              <p className="mt-4 text-sm sm:text-base">
                connect to PancakeSwap. Go to pancakewap.finance, connect your
                wallet. Paste the $BOB token address into PancakeSwap,select
                BOB,and confirm When Metamask prompts you for a wallet
                signature,sign.
              </p>

              <p className="mt-8 font-bold">
                <a href="https://pancakeswap.finance/swap?outputCurrency=0xE89715D87C33221bc76b4F3162Cc4a1CB0da0E19">
                  Go now
                </a>
              </p>
            </div>
        ...
        >
          ...
          <div className="rounded-xl relative flex h-full transform items-end border-2 border-[#E8AA42] bg-white transition-transform group-hover:-translate-x-2 group-hover:-translate-y-2">
            ...
            <div className="absolute p-4 opacity-0 duration-300 transition-opacity group-hover:relative group-hover:opacity-100 sm:p-6 lg:p-8">
              ...
              <p className="mt-4 text-sm sm:text-base">
                switch BNB for $BOB. We have ZERO taxes so you don't need to
                warry about buying with a specigi slippage,although you may need
                to use slippage during times of market volatity.
              </p>
