  ...
  return (
    <div className="mx-16 my-16 xl:my-60 md:mx-28 md:my-32">
      ...
      <h1 className="mt-4 xl:mt-8 font-bold text-white font-Orbitron md:text-5xl xl:text-5xl">
        ...
        <h1 className="mt-5  font-bold text-white font-Orbitron md:text-5xl xl:text-7xl"> {"TAX 9/9 =>"} </h1>
        <div id="dotted" className="outline-dotted outline-4 outline-white p-1 mt-8 rounded-lg"> 
