...
export default function About(){
    ...
    return(
        ...
        <button className="font-semibold rounded-xl hover:scale-150 border-[#E57C23] hover:shadow-2xl hover:border-2 transition-transform font-Orbitron bg-black text-[#E57C23] p-4"> Coming Soon!!! </button>
        </Link>
                </div>
